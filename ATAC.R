...
# library of txn start sites: TSS.human.GRCh37
...
# Input peaks and annotation; Annotation: txn start side; compare ranges 
...
# for each peak in the the atacseq list look for the closest overlap
...
#count how many peaks have a match for a motif
# get peaks
